...
def display_banner():
   ...
   1 --> Get Pc Info     |  2 --> Roblox Id Info    |  3 --> Roblox User Info |  4 --> Roblox Private Server Gen
   5 --> Ip Generator    |  6 --> IpLookup          |  7 --> Get Your Ip      |  8 --> Nitro Generator
   9 --> Webhook Info    | 10 --> Webhook Deleter   | 11 --> Webhook Spammer  | >> --> 2nd Page
"""
...
def main():
    ...
    if choice == "1":
        ...
        script_path = os.path.join("core", "privserv.py")
