...
def get_roblox_user_info_by_username(username):
    # Roblox API URL to fetch user ID by username
    ...
    if response.status_code == 200:
        ...
        if 'Id' in user_data:
            ...
            return get_roblox_user_info(user_id)
        else:
            print(Fore.BLUE + "Error: Username not found.")
            return None
    else:
        print(Fore.BLUE + "Error: Unable to retrieve user ID by username.")
        return None
...
def main():
    # Ask for the Roblox username
    username = input(Fore.BLUE + "Please enter the Roblox username: ")
    
    # Retrieve user information
    user_info = get_roblox_user_info_by_username(username)
